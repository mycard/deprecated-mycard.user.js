// ==UserScript==
// @name       MyCard User Script
// @namespace  http://mycard.in
// @version    0.2
// @description  A userscript help convert Yu-Gi descriptive text to mycard decks
// @match      http://*/*
// @copyright  2013+, ekoneko
// ==/UserScript==
  ...
  CardDeck = (function() {
    ...
    render = function(panel, position, deckName, cardUsage, callback) {
      ...
      if (position.left + 828 > clientWidth) {
        position.left = clientWidth > 0 ? clientWidth - 828 : 0;
      }
